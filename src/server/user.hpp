...
public:
    ...
    ///< Length of bytes that #user_socket accepts at a time.
...
private:
    buffer_t inner_buffer;
    ///< This buffer stores bytes that were recieved from last call User::read_message.

    sockfd_t user_socket;
    sockaddr_in user_socket_addr;
    std::string nickname;
    user_ptr rommate = nullptr;
    ///< Points to #User who will recieve private messages.
};
